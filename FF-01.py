...
"""
Flexible Flash
Черная линия сглаженая коротким периодом цена, для устранения шумов 
...
"""
cache = diskcache.Cache("./cache_ff")
...
VERSION = f'BTC Flexible Flash #01, Plotly V{VER_P}, Dash V{VER_D}, Bootstrap V{VER_B}'
