...
"""
cache = diskcache.Cache("./cache_ff_03")
...
VERSION = f'BTC Flexible Flash #03, Plotly V{VER_P}, Dash V{VER_D}, Bootstrap V{VER_B}'
...
if __name__ == '__main__':
    app.run_server(host='0.0.0.0', port=8054, debug=False, use_reloader=True)
